...
for root, dirs, files in os.walk(data_folder):
    ...
    for dir in dirs:
        ...
        mask_file = os.path.join(subFolder, 'mask.png')

        if not os.path.isfile(os.path.join(subFolder, 'mask.png')):
            print ("File {} does not exist".format(mask_file))
            continue
